...
class Item extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('category_one, category_two, category_three, brand_id, share, view, volume, collect, is_shelve, is_delete, is_free_postage, create_time', 'numerical', 'integerOnly'=>true),
			array('item_name, item_sn', 'length', 'max'=>255),
			array('item_point, item_price', 'length', 'max'=>15),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, item_name, item_sn, item_point, item_price, category_one, category_two, category_three, brand_id, share, view, volume, collect, is_shelve, is_delete, is_free_postage, desc, create_time', 'safe', 'on'=>'search'),
		);
	}
