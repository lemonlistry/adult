...
<div class="main-box">
    <div class="main-body">
        ...
        <div class="main-container prepend5">
            <header>
                <div class="right">
                    <?php echo Html5::link('添加角色类型', array('/passport/role/addrolegroup'), array('class' => 'js-dialog-link')); ?>
                </div>
            </header>
                        ...
                        <tbody>
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                    echo Html5::link('编辑', array('/passport/role/updaterolegroup', 'id' => $v->id), array('class' => 'js-dialog-link')) . ' ' .
                                                    Html5::link('删除', array('/passport/role/deleterolegroup', 'id' => $v->id), array('class' => 'js-confirm-link', 'data-title' => "您确定要删除当前角色类型吗？"));
                                                ?>
                                            </td>
                                        </tr>
                                <?php 
